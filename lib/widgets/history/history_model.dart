...
class ModelHistoryBox extends StatefulWidget {
  const ModelHistoryBox(
      {super.key, required this.companyName, required this.companyId});
  final String companyName;
  final String companyId;
  @override
  State<ModelHistoryBox> createState() => _ModelHistoryBoxState();
}

class _ModelHistoryBoxState extends State<ModelHistoryBox> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        context
            ...
            .funcAGetModelCompanyDetail(widget.companyId);
      },
      child: Padding(

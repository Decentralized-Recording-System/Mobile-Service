...
class ContractBox extends StatefulWidget {
  const ContractBox(
      {super.key,
  ...
  @override
  State<ContractBox> createState() => _ContractBoxState();
}

class _ContractBoxState extends State<ContractBox> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        context
            ...
            .funcAGetContractData(widget.modelContractId);
      },
      child: Padding(
